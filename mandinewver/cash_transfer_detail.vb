...
Public Class cash_transfer_detail
    ...
    Public Sub show_transfer_detail()
        ...
        abc = New SqlCommand("select a.transferdate,b.date,a.fromcustid,tocustid,b.amount from transfer_cash a,voucher b where a.voucherid=b.voucher_id and a.transferdate>=@dt1 and a.transferdate<=@dt2 and a.companyid=@companyid")
