...
Public Class bikribook
    Dim a7 As New predefined
    Dim choice As String
    Dim laga, arhat As Double
    ...
    Private Sub TextBox6_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles TextBox6.KeyPress
        ...
        If RadioButton4.Checked = True Then
            Dim mann As Decimal
            mann = Val(TextBox6.Text) / 40
            If Val(TextBox5.Text) > 0 Then
                TextBox7.Text = Val(TextBox5.Text) * Val(mann)
            Else
                TextBox7.Text = Val(TextBox4.Text) * Val(mann)
            End If
        End If
    ...
    Public Sub cal_grand()
        ...
        If choice = "N" Then
            ...
            gtotal = Val(TextBox7.Text) + Val(TextBox8.Text) + Val(TextBox9.Text)
            TextBox10.Text = gtotal
        Else
            TextBox9.Text = (Val(TextBox4.Text) * laga)
    ...
    End Sub
    Private Sub bikribook_KeyUp(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles Me.KeyUp
        If e.KeyCode = Keys.Escape Then
            Me.Close()
        End If
    End Sub
    Private Sub bikribook_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        company_add()
        book_add()
        ListBox1.Visible = False
        ListBox2.Visible = False
    ...
    Private Sub ListBox2_KeyUp(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles ListBox2.KeyUp
        ...
        End If
    End Sub
    Private Sub ListBox1_KeyUp(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs)
        If e.KeyCode = Keys.Enter Then
    ...
    Public Sub insert_data()
        ...
        narration = TextBox2.Text & " " & "(" & TextBox4.Text & "Nag" & "," & " " & TextBox5.Text & "Kg" & " " & "@" & TextBox6.Text & "=" & " " & TextBox7.Text & ")"
        ...
        Try
            ...
            abc.Parameters.Add("@bname", SqlDbType.VarChar).Value = TextBox1.Text
    ...
    Private Sub TextBox15_KeyUp(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs)
        ...
        End If
    End Sub
    Private Sub TextBox18_KeyUp(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs)
        If e.KeyCode = Keys.Enter Then
            TextBox3.Focus()
        End If
    End Sub
    ...
    Private Sub TextBox15_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs)
        e.Handled = a7.trapkey(Asc(e.KeyChar))
    End Sub
    Private Sub TextBox15_KeyUp1(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs)
        If e.KeyCode = Keys.Enter Then
            TextBox18.Focus()
        End If
    End Sub
    Private Sub TextBox18_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs)
        e.Handled = a7.trapkey(Asc(e.KeyChar))
    End Sub
    Private Sub TextBox18_KeyUp1(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs)
        If e.KeyCode = Keys.Enter Then
            TextBox3.Focus()
        End If
    End Sub
    Private Sub RadioButton3_GotFocus(ByVal sender As Object, ByVal e As System.EventArgs) Handles RadioButton3.GotFocus
        TextBox6.Focus()
    End Sub
