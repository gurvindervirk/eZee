...
Public Class billtransfer
    ...
    Public companyid, voucherid, customerid, customerid1 As Integer
    ...
    Private Sub Button1_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles Button1.Click
        ...
        If Val(TextBox3.Text) > Val(TextBox2.Text) Then
            MsgBox("Can't Add Cash Customer's Balance is less then deposit Amount", MsgBoxStyle.Information, "Less balance")
            TextBox3.Focus()
            Exit Sub
        End If
        ...
        Try
            ...
            abc3 = New SqlCommand("insert into transfer_cash(companyid,sessionid,fromcustid,tocustid,transferdate,voucherid,amount)values(@companyid,@sessionid,@fromcustid,@customerid,@transferdate,@voucherid,@amount)")
    ...
    Public Sub prv_balance()
        ...
        sum_dr = 0
        sum_cr = 0
        abc = New SqlCommand("select sum(amount) from voucher where companyid=" & companyid & " and sessionid=" & MDIParent1.sessionid & " and cid=" & customerid1 & " and account_desc='" & account_desc & "'")
        Dim xyz(0), xyz1(0) As String
        a7.array_list(abc, xyz, 0)
        sum_dr = xyz(0)
        abc1 = New SqlCommand("select sum(amount) from voucher where companyid=" & companyid & " and sessionid=" & MDIParent1.sessionid & " and cid=" & customerid1 & " and account_desc='" & account_desc1 & "'")
    ...
    End Sub
    Private Sub billtransfer_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
